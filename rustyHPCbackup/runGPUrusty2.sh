...
#SBATCH --job-name=Gg02max       # Assign a short name to your job
...
#SBATCH --time=72:00:00           # Total run time limit in minutes
...
srun julia $HOME/CPGE/KPMGammaRead.jl $SLURM_ARRAY_TASK_ID @> output${SLURM_ARRAY_TASK_ID}.log
