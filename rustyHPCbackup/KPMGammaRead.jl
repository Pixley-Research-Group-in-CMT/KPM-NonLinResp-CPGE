...
Ws = exp.(LinRange(log(0.02),log(2),20))
W = Ws[disind]
...
#Ham = H0 + spdiagm(disorders[:,disind])#disind])
...
fn = "/mnt/home/awu10/ceph/CPGEdata/GammamnpL100gam04D6NC512NR1S1Ws"*"$disind"*".jld2"
jldsave(fn; Ls=Ls, NC=NC, D = D, Gammaxyz=mu_3d_xyz, Gammayxz=mu_3d_yxz,Ws=Ws,ind=disind)
