...
#SBATCH --partition=gpu          # Partition (job queue) main or gpu

#SBATCH --requeue                 # Return job to the queue if preempted

#SBATCH --job-name=L100c27       # Assign a short name to your job
...
srun julia $HOME/CPGE/SpeedTestsLs.jl $SLURM_ARRAY_TASK_ID @> output${SLURM_ARRAY_TASK_ID}.log
