...
Ham = H0 + spdiagm(disorder) #spdiagm(disorders[:,disind])#disind])
@time Jx, Jy, Jz = velocityOperator(Ls,Ham) # same as no disorder
...
fn = "/scratch/aw666/CPGEdata/GammamnpL100gam08D6NC512W01NR1Sam"*"$disind"*".jld2"
#fn = "GammamnpL100gam08D6NC32W01maxNR1Sam"*"$disind"*".jld2"
